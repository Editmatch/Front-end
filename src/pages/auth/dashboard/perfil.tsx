...
function EditInfo() {
  ...
  const fetchProfileImage = async () => {
    try {
      const response = await axios.get(
        `${apiUrl}/usuarios/${sessionStorage.getItem("userId")}/photo`,
        {
          headers: {
  ...
  const saveInfo = async () => {
    axios
      .post(
        `${apiUrl}/enderecos/${sessionStorage.getItem("userId")}`,
        {
          cidade: localidade,
          cep: cep,
          ...
          <div className="row mt-5">
            <div className="row">
              <div className="col-1 col-md-2 text-center">
                <Imagem
                  className="mb-4"
                  src={imagen ? imagen : defaultImage}
                  alt="Foto da pessoa"
                />
                <input
                  type="file"
                  className="form-control"
                  onChange={trocarImagemOnChange}
                />
              </div>
                  ...
                  <div className="row">
                    <div className="col-6 col-md-6">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        defaultValue={sessionStorage.getItem("usuario") ?? ""}
                      />
                    </div>
                    <div className="col-6 col-md-6">
