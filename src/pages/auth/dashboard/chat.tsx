...
function Chat() {
    ...
    const chatMock = [
        ...
        },
        {
            id: 2,
            name: "Danny Smith",
            message: "50 conto e nos desenrola ",
                                ...
                                <MDBRow>
                                    ...
                                    <MDBCol md="6" lg="7" xl="8">
                                        <div className="d-flex flex-row justify-content-start">
                                            ...
                                            <div>
                                                <p
                                                    ...
                                                    style={{ backgroundColor: "#fffff", color: "#000", border:"1px solid #000"}}
                                                >
                                        ...
                                        <div className="d-flex flex-row justify-content-end">
                                            <div>
                                                <p className="small p-2 me-3 mb-1 text-white rounded-3" style={{backgroundColor: "#333333"}}>
